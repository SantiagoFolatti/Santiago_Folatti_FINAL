...
def inicializar_ventana(ancho=800, alto=600, titulo="TRIVIA PELÍCULAS", 
    ruta_fondo=r"Santiago_Folatti_FINAL\imagenes_sonidospygame\fondo.jpg",
    ruta_icono=r"Santiago_Folatti_FINAL\imagenes_sonidospygame\utn_icono.jpg", 
    ruta_sonido_click=r"Santiago_Folatti_FINAL\imagenes_sonidospygame\mouse-click-290204.mp3",
...
def crear_boton(dimensiones, posicion, ventana, accion=None, 
                color_fondo=None, color_borde=None, imagen=None, 
                fuente=None, texto=None):
    boton = {
        "Ventana": ventana,
...
def checkear_accion_botones(lista_botones, evento,click_sonido):
    resultado = None
    for boton in lista_botones:
        if boton["Rectangulo"].collidepoint(evento.pos):
            boton["Presionado"] = True
            click_sonido.play()
            resultado = boton["Accion"]()   
            break
    return resultado
